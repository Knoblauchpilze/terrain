#ifndef    OLC_PGE_DEF_ADDITIONAL_COLOURS_HH
# define   OLC_PGE_DEF_ADDITIONAL_COLOURS_HH
...
namespace olc {
  ...
  {
    hue = std::min(std::max(hue, 0.0f), 360.0f);
...
#endif    /* OLC_PGE_DEF_ADDITIONAL_COLOURS_HH */
