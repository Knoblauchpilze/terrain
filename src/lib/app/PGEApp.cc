...
PGEApp::InputChanges PGEApp::handleInputs()
{
  ...
  b                                  = GetKey(olc::L);
  m_controls.keys[controls::keys::L] = b.bReleased;

  b                                  = GetKey(olc::C);
  m_controls.keys[controls::keys::C] = b.bReleased;

  b                                  = GetKey(olc::I);
  m_controls.keys[controls::keys::I] = b.bReleased;

  b                                  = GetKey(olc::O);
  m_controls.keys[controls::keys::O] = b.bReleased;

  b                                  = GetKey(olc::F);
  m_controls.keys[controls::keys::F] = b.bReleased;
