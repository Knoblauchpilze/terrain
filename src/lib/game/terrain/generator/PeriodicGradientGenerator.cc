...
PeriodicGradientGenerator::PeriodicGradientGenerator(const int period, const noise::Seed seed)
...
void PeriodicGradientGenerator::generate(const int period, const noise::Seed seed)
{
