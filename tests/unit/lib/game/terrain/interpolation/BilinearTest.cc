...
TEST(Bilinear, Test_Interpolate_LatticePoints)
{
...
TEST(Bilinear, Test_Interpolate_X_Edges)
{
  auto interpolator = Bilinear();
...
TEST(Bilinear, Test_Interpolate_Y_Edges)
{
  auto interpolator = Bilinear();
...
TEST(Bilinear, Test_Interpolate_Quadrants)
{
  auto interpolator = Bilinear();
